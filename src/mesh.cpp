...
void Mesh::CreateFullscreenQuad() {
  ...
  UploadIndexed(quadVerts, sizeof(quadVerts), quadIdx, 6);
  SetAttrib(0, 2, GL_FLOAT, GL_FALSE, 2 * sizeof(float), 0);
}

void Mesh::CreateFromFlowfieldData(const MeshFlowfieldData& d) {
